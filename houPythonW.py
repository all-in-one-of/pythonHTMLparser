...
sys.path.append("H:/HoudiniSetPAth/pyth")
...
fbxPath="H:/HoudiniSetPAth/pig.fbx"
...
data = []
print("DTJSon")
with open("H:\HoudiniSetPAth\pyth\outputSdPath.jsonl") as f:
        for line in f:
...
#test for creating and positioning cameras
    ...
    myCam.parmTuple('t').set([0,trX*5,0])
